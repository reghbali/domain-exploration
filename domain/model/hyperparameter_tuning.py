...
root_dir = '/Users/riley/Desktop/DomainResearch/domain-exploration'
...
def get_args():
    ...
    parser.add_argument('--architecture', type=str, required=True, help='Model architecture (MLP, CNN, ResCNN, VisionTransformer)')
